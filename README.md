...
You can view the slides online at [neuroinformatics.dev/slides-trusted-by-design](https://neuroinformatics.dev/slides-trusted-by-design/#/title-slide).
...
Throughout the talk, I'll draw on examples from [movement](https://movement.neuroinformatics.dev) — a Python package I develop — and other tools built by the [Research Software Engineering team](https://neuroinformatics.dev) I'm part of. That said, the lessons should be applicable to any free open-source project that aspires to attract and sustain a healthy community.
